...
from observability.stacks.resource_discovery_stack import ResourceDiscoveryStack
from observability.stacks.slack_integration_stack import SlackIntegrationStack
...
# Resource discovery and auto-monitoring
resource_discovery_stack = ResourceDiscoveryStack(
    app, f"ObservabilityDiscovery-{env_name}",
    env=env,
    environment=env_name,
    core_resources=core_stack.core_resources
)
...
slack_stack = SlackIntegrationStack(
    app, f"ObservabilitySlack-{env_name}",
    env=env,
    environment=env_name,
    core_resources=core_stack.core_resources,
